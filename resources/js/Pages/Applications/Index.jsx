...
const APP_TYPES = ["Locational Clearance", "Zoning Certification", "Development Permit"];
                                ...
                                {userRole === "Planning Officer" && (
                                    <div className="flex items-center gap-3">
                                        ...
                                        <a
                                            ...
                                            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-[10px] bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-700 text-[12px] font-bold shadow-sm transition-all active:scale-95"
                                        >
