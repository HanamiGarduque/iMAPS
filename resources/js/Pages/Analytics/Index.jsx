...
// ── Sidebar (same as Application module) ──────────────────────────────────────
    ...
    return (
        <>
            ...
            <div className="flex h-screen overflow-hidden">
                ...
                {/* ── SIDEBAR (same as Applications) ── */}
                <Sidebar userName={userName} userRole={userRole} />

                <div className="flex-1 flex flex-col overflow-hidden">

                    {/* ── TOP BAR (same as Applications) ── */}
                    ...
                    <main className="flex-1 overflow-y-auto px-6 py-6">
                        <div className="max-w-[1600px] mx-auto w-full space-y-6">
                            ...
                            {/* ── FILTERS ── */}
                            <div className="fade-up bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-wrap gap-4 items-end"
                            ...
                            <div className="fade-up grid grid-cols-2 lg:grid-cols-4 gap-4">
                                <div onClick={() => setDrillDown({ open: true, title: 'Total Applications', category: 'All' })}
                                    className="bg-white rounded-2xl border border-slate-200 p-5 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-pointer"
                                    style={{ boxShadow: '0 1px 3px rgba(0,0,0,.04)' }}>
                                ...
                                <div className="bg-white rounded-2xl border border-slate-200 p-5 hover:-translate-y-1 hover:shadow-md transition-all duration-300"
                                    style={{ boxShadow: '0 1px 3px rgba(0,0,0,.04)' }}>
                                                ...
                                                <div key={b.name} className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="w-full bg-slate-100 rounded-full h-1.5">
                                                            <div className="bg-blue-600 h-1.5 rounded-full transition-all duration-500" style={{ width: `${barWidth}%` }} />
                                                        </div>
                                                    </div>
                                                </div>
                                            );
                            ...
                            <div className="fade-up grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div onClick={() => setDrillDown({ open: true, title: 'Status Distribution', category: 'All' })}
                                    className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-pointer"
                                    style={{ boxShadow: '0 1px 3px rgba(0,0,0,.04)' }}>
                            ...
                            {/* ── HISTORICAL TREND ── */}
                            <div className="fade-up bg-white rounded-2xl border border-slate-200 p-5 sm:p-6"
                                style={{ boxShadow: '0 1px 3px rgba(0,0,0,.04)' }}>
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[85vh] flex flex-col">
                        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50 rounded-t-xl">
                            ...
                            <button onClick={() => setDrillDown({ open: false, title: '', category: '' })}
                                className="w-8 h-8 rounded-lg border border-slate-200 flex items-center justify-center text-slate-400 hover:text-slate-800 hover:bg-slate-50 transition-colors">
                                    ...
                                    {drillRows.map(r => (
                                        <tr key={r.id} className="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className="py-3 px-6 text-xs">
                                                <span className="inline-block px-2 py-1 rounded bg-slate-100 text-slate-600 text-[11px] font-medium">{r.type}</span>
                                            </td>
